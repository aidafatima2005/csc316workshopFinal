...
public class EdgeListGraph<V, E> extends AbstractGraph<V, E> {
	...
	/** Test Variable for vertex list of type positional list */
    private PositionalList<Vertex<V>> vertexList;
    
    /** Test Variable for edge list of type positional list */
    ...
    /**
     * Retrieves a list of all outgoing edges for the specified vertex.
     * 
     * In a directed graph, this includes all edges where the specified vertex is the source.
     * In an undirected graph, this includes all edges connected to the vertex regardless of direction.
     *
     * @param vertex the vertex whose outgoing edges are to be retrieved
     * @return a list of outgoing {@code Edge<E>} instances for the specified vertex
     * @throws IllegalArgumentException if the given vertex or an edge in the graph is not valid
     */
     ...
     * 
     * In a directed graph, this includes all edges where the specified vertex is the destination.
     * In an undirected graph, this includes all edges connected to the vertex regardless of direction.
     *
     ...
     * @throws IllegalArgumentException if the vertex or an edge in the graph is not valid
     */
     ...
     * @return a new {@code GraphVertex} containing the specified data
     */
    ...
    /**
     * Creates a new edge connecting two vertices with the given data.
     *
     ...
     * @return a new {@code GraphEdge} representing a connection between {@code vertex1} and {@code vertex2}
     */
