...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    protected class EntryCollection implements Iterable<Entry<K, V>> {
    	...
    	/** A list of entries that stores key and value pairs */
    ...
    protected class ValueIterator implements Iterator<V> {
         ...
         *
         * @return the next value from the map's entries
         */
        @Override
        public V next() {
         ...
         * 
         * @throws UnsupportedOperationException if the remove operation is not supported yet
         */
        @Override
        public void remove() {
            throw new UnsupportedOperationException("The remove operation is not supported yet.");
    ...
    /**
     * Returns an iterable view of all values in this map.
     * 
     * @return an iterable view of all values in this map
     */
    @Override
    ...
    private class ValueIterable implements Iterable<V> {
    	...
    	/**
         * Returns a new iterator over the values in this map.
         *
         * @return a new instance of {@link ValueIterator}
         */
    	 @Override
