...
public abstract class AbstractTree<E> implements Tree<E> {
    ...
    /**
     * Updates the element stored at position p 
     * 	and returns the original element that was replaced
     * 
    ...
    public Iterable<Position<E>> levelOrder() {
    	...
    	if (!isEmpty()) {
        	...
        	while (!queue.isEmpty()) {
        		...
        		if(q.getElement() != null) {  // do not add sentinel nodes to the traversal
                    traversal.add(q);
                }
    ...
    protected class PositionCollection implements Iterable<Position<E>> {
    	...
    	/** Variable representing the list */
