...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
	...
	/** Variable representing root */
    private BinaryTreeNode<E> root;
    
    /** Variable representing tree size */ 
    private int size;
    ...
    public static class BinaryTreeNode<E> extends AbstractTreeNode<E> {
    	...
    	/** Variable representing parent node */
        private BinaryTreeNode<E> parent;
        
        /** Variable representing left node */
        private BinaryTreeNode<E> left;
        
        /** Variable representing right node */
    ...
    public E remove(Position<E> p) {
        ...
        // Get the child of the node to be removed (if any)
        ...
        // Handle the case where the node is the root
        if (node == root) {
            if (child != null) {
                child.setParent(null); // The child becomes the new root
            }
            root = child; // Update the root
        } else {
            // Handle the case where the node is not the root
            BinaryTreeNode<E> parent = node.getParent();
            if (parent.getLeft() == node) {
                parent.setLeft(child); // Replace the node with its child
            } else {
                parent.setRight(child); // Replace the node with its child
            }
            
            if (child != null) {
                child.setParent(parent); // Update the parent of the child
            }
        }
