...
public class AdjacencyListGraphTest {
    ...
    /**
     * Builds a sample undirected graph with five cities as vertices and
     * connects them using weighted edges.
     * 
     * This method inserts vertices representing city names and establishes
     * bidirectional (undirected) connections between them with integer weights.
     * It is primarily intended for testing or demonstration purposes.
     */
    ...
    /**
     * Builds a sample directed graph with six cities as vertices and
     * connects them using weighted directed edges.
     * 
     * This method inserts vertices representing city names and creates
     * one way (directed) connections between them with integer weights.
     * It is primarily intended for testing or demonstration purposes.
     */
