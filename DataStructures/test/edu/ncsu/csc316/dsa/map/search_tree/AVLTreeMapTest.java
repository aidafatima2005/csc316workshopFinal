...
public class AVLTreeMapTest {
	...
	/** Test variable Tree */
    private AVLTreeMap<Integer, String> tree;
    ...
    public void testPut() {
        ...
        // Insert elements to trigger a single rotation (right rotation)
        tree.put(3, "three");        
        tree.put(2, "two");
        tree.put(1, "one");
        ...
        // Insert elements to trigger a single rotation (left rotation)
        tree.put(4, "four");
        tree.put(5, "five");
        ...
        // Insert elements to trigger a double rotation (right-left rotation)
        tree.put(6, "six");
    ...
    public void testRemove() {
        ...
        // Test removing a leaf node (no restructuring needed)
        ...
        // Test removing a node with one child (triggers restructuring)
        ...
        // Test removing the root (triggers restructuring)
        assertEquals("three", tree.remove(3));
        assertEquals(3, tree.size());
        
        // After removing the root (3), the new root should be 4 (inorder successor)
        assertEquals(4, (int)tree.root().getElement().getKey());
        assertEquals(2, (int)tree.left(tree.root()).getElement().getKey());
        assertEquals(5, (int)tree.right(tree.root()).getElement().getKey());    
    }
