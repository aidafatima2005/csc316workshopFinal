...
/**
 * This class contains unit tests for the InsertionSorter class.
...
public class InsertionSorterTest {
	...
	/** An InsertionSorter instance for sorting integers. */
	private InsertionSorter<Integer> integerSorter;
	
	/** A Student object representing the first student. */
	private Student sOne = new Student("A", "A", 3, 1, 4.0, "oneUnityID");
	
	/** A Student object representing the second student. */
	private Student sTwo = new Student("B", "B", 4, 2, 5.0, "twoUnityID");
	
	/** A Student object representing the third student. */
	private Student sThree = new Student("C", "C", 5, 3, 1.0, "threeUnityID");
	
	/** A Student object representing the fourth student. */
	private Student sFour = new Student("D", "D", 1, 4, 2.0, "fourUnityID");
	
	/** A Student object representing the fifth student. */
	...
	/** An array of Student objects in random order. */
	private Student[] studentRandom = {sThree, sOne, sFive, sFour, sTwo};

	/** An InsertionSorter instance for sorting Student objects. */
	private InsertionSorter<Student> studentSorter;

	/**
     * Sets up the test environment before each test method is executed.
     * Initializes the integer and student sorters.
     */
	@Before
	public void setUp() {
    ...
    /**
     * Tests the sorting of Integer arrays using InsertionSorter.
	...
	/**
     * Tests the sorting of Student arrays using InsertionSorter.
    ...
    /**
     * Tests the sorting of Student arrays using InsertionSorter with a custom StudentIDComparator.
	...
	public void testSortStudentsByID() {
		...
		Sorter<Student> sortStudentByID = new InsertionSorter<Student>(sample);
    ...
    /**
     * Tests the sorting of Student arrays using InsertionSorter with a custom StudentGPAComparator.
	...
	public void testSortStudentsByGPA() {
		...
		Sorter<Student> sortStudentByGPA = new InsertionSorter<Student>(sample);
